...
describe("Traversing DOM elements in Cypress", () => {
  ...
  it("eq() to retrieve a specific element based on index", () => {
    //cy.get('.traversal-drinks-list > *').eq(2).should('have.id','milk') // alternative way
  ...
  it.only("siblings() To get all sibling DOM elements of elements", () => {
   ...
   // cy.get('.traversal-button-other-states').find('.active').siblings().should('have.length',3) // alternative way
  });
});
